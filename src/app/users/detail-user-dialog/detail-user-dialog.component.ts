...
import { RoleDto, UserDto, UserServiceProxy, UserTypeDto, UserTypeServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class DetailUserDialogComponent extends AppComponentBase implements OnInit {
  saving = false;
  id: number;
  user = new UserDto();
  roles: RoleDto[] = [];
